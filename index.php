...
?>
    ...
    <div class="container">
      <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
        <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
          <img src="images/featuers/wifi.svg" width="80px">
          <h5 class="mt-3">Wifi</h5>
        </div>
        <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
          <img src="images/facilities/cond.svg" width="80px">
        ...
        <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
          <img src="images/facilities/televison.svg" width="80px">
          <h5 class="mt-3">Telvision</h5>
        </div>
        <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
    ...
    <div class="swiper swiper-testimonials">
      <div class="swiper-wrapper mb-5">
        ...
        <div class="swiper-slide pg-white p-4">
          <div class="profile d-flex align-items-center mb-3">
            <img src="images/featuers/star-fill.svg" width="30px">
            <h6 class="m-0 ms-2">Random user1</h6>
          </div>
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quo illo labore 
            officiis sapiente asperiores exercitationem eveniet, dolores harum
            nulla numquam.
          </p>
          <div class="rating">
            <i class="bi bi-star-fill text-warning"></i>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-8 p-4 mb-lg-0 mb-3 bg-white rounded">
          <iframe class="w-100 rounded" height="320" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d433869.38330790447!2d35.9476308!3d31.83576035!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151b5fb85d7981af%3A0x631c30c0f8dc65e8!2z2LnZhdmR2KfZhg!5e0!3m2!1sar!2sjo!4v1667412597765!5m2!1sar!2sjo"   loading="lazy"></iframe>
        </div>
        <div class="col-lg-4 col-md-4">
          <div class="bg-white 0-4 rounded mb-4"> 
            <h5>Call Us</h5>
