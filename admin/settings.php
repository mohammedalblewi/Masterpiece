...
<body class="bg-light">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <button type="button" class="btn btn-dark shadow-none tn-sm" data-bs-toggle="modal" data-bs-target="#general-s">   
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <div class="form-check form-switch">
                            <form >
                                <input onchange="upd_shutdown(this.value)" class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault">
                            </form>
                    ...
                    <p class="card-text">
                        No Custumers will be allowed to book hotel room, when shutdown mode is turned on.
                    </p>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <button type="button" class="btn btn-dark shadow-none tn-sm" data-bs-toggle="modal" data-bs-target="#contacts-s">   
                            <i class="bi bi-pencil-square"></i>    Edit
                            </button>
                        </div>
                        <div class="row">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <button type="button" class="btn btn-dark shadow-none tn-sm" data-bs-toggle="modal" data-bs-target="#team-s">   
    ...
    <script>
        ...
        function get_general(){
            ...
            xhr.open("POST","./aout/settings_crud.php",true);
        ...
        function add_member(){
           ...
           data.append('name',member_picture_inp.files[0]);
